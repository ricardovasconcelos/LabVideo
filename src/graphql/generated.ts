...
export type GetLessonsQuery = { __typename?: 'Query', lessons: Array<{ __typename?: 'Lesson', title: string, slug: string, id: string, lessonType: LessonType, availableAt?: any | null }> };
